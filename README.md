...
[Bhavya Narula](https://github.com/Bhavya-narula) developed a JSON reader to support FFA candidate inputs.  
For details, please refer to the `json-reader` branch.
